...
export default class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        //@ts-ignore
        this.landWaveSegmentCollider = this.physics.add.overlap(
            this.waveSegments,
            this.landTiles,
            this.handleWaveSegmentLandCollision,
            undefined,
            this,
        );
    ...
    private handleWaveLighthouseCollision(
        lighthouse: Phaser.GameObjects.GameObject,
    ...
    private handleWaveLandCollision(
        waveObject: Phaser.GameObjects.GameObject,
    ...
    private handleWaveSegmentLandCollision(
    ...
    private checkWaveLightCollision(currentAngle: number) {
        const processBeam = (angle: number) => {
            ...
            all.forEach((go) => {
                ...
                if (GameManager.lightAngle >= 180) {
                    inBeam = true; // Full 360 coverage
                } else {
