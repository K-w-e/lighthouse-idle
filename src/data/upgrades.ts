...
export const upgrades: { [key: string]: Upgrade[] } = {
    offensive: [
      ...
      value: 1,
        ...
        },
        {
            ...
            name: "Lightning",
            description:
                "When the light beam destroys a wave, there is a chance it will chain to a nearby wave, destroying it as well (+5% chance).",
            cost: 2000,
            costIncrease: 1.5,
            value: 0.05,
        },
        {
            ...
            name: "Mega Bomb",
            description:
                "Unleashes a powerful explosion, destroying all waves in a large radius. Can be activated once every 60 seconds.",
            cost: 10000,
    ...
    defensive: [
        ...
        },
        {
            ...
            name: "Slowing Pulse",
            description:
                "Emits a pulse every 5 seconds that slows all waves on screen. Each upgrade increase slow effect.",
            cost: 1500,
            costIncrease: 1.5,
            value: 0.1,
        },
    ...
    economic: [
        {
            ...
            name: "Core Crystal",
            description:
                'Increases the passive "Light" generated per second (+1).',
            cost: 25,
            costIncrease: 1.2,
            value: 1,
        },
        ...
        },
        {
            ...
            name: "Kinetic Siphon",
            description:
                'Waves hitting the shield grant a small bonus "Light" (+0.5).',
            cost: 150,
            costIncrease: 1.5,
            value: 0.5,
        },
        {
            ...
            name: "Tidal Force",
            description:
                'Increases passive "Light" generation based on the number of active waves (+0.1).',
            cost: 1000,
            costIncrease: 1.8,
            value: 0.1,
        },
        ...
        },
        {
            ...
            name: "Light Interest",
            description:
                'Passively generate "Light" based on a percentage of your current "Light" total (+0.1%).',
            cost: 5000,
            costIncrease: 2.5,
            value: 0.001,
        },
        ...
        },
        {
            ...
            name: "Time Warp",
            description:
                "Speeds up time for 10 seconds, accelerating all processes. 2 minutes cooldown.",
            cost: 25000,
            costIncrease: 1, // a single purchase
        },
    ],
    energy: [
        ...
        },
        {
            ...
            name: "Overcharge",
            description:
                "Gives a small chance to receive a large energy boost when clicking the lighthouse (+1% chance).",
            cost: 1000,
            costIncrease: 1.8,
            value: 0.01,
        },
        {
            ...
            name: "Energy Siphon",
            description:
                "Gain a small amount of energy for each wave destroyed (+0.1).",
            cost: 2000,
            costIncrease: 1.7,
            value: 0.1,
        },
